	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('display-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('upperDisplay')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(model.upperDisplay)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('lowerDisplay')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(model.lowerDisplay)
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('button ce-button'),
								$elm$html$Html$Events$onClick($author$project$Main$ClearEntry)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('button c-button'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('button operation-button'),
								$elm$html$Html$Events$onClick($author$project$Main$Calculate)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromChar(
									$elm$core$Char$fromCode(61)))
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
